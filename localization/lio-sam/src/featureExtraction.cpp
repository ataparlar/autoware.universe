...
public:
    ...
    rclcpp::Subscription<autoware_localization_msgs::msg::CloudInfo>::SharedPtr subLaserCloudInfo;
    ...
    {
        subLaserCloudInfo = create_subscription<autoware_localization_msgs::msg::CloudInfo>(
            "lio_sam/deskew/cloud_info", qos,
            std::bind(&FeatureExtraction::laserCloudInfoHandler, this, std::placeholders::_1));

        pubLaserCloudInfo = create_publisher<autoware_localization_msgs::msg::CloudInfo>(
