#include "utility.hpp"
#include "autoware_localization_msgs/msg/cloud_info.hpp"
...
public:
    ...
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr pubCloudMapSurface;
    rclcpp::Publisher<sensor_msgs::msg::PointCloud2>::SharedPtr pubCloudMapCorner;
    rclcpp::Publisher<visualization_msgs::msg::MarkerArray>::SharedPtr pubLoopConstraintEdge;

//    rclcpp::Service<autoware_localization_msgs::srv::SaveMap>::SharedPtr srvSaveMap;
    rclcpp::Subscription<autoware_localization_msgs::msg::CloudInfo>::SharedPtr subCloud;
    rclcpp::Subscription<nav_msgs::msg::Odometry>::SharedPtr subGPS;
    rclcpp::Subscription<std_msgs::msg::Float64MultiArray>::SharedPtr subLoop;

    std::deque<nav_msgs::msg::Odometry> gpsQueue;
    autoware_localization_msgs::msg::CloudInfo cloudInfo;
    ...
    mapOptimization(const rclcpp::NodeOptions & options) : ParamServer("lio_sam_mapOptimization", options)
    {
        ...
        subCloud = create_subscription<autoware_localization_msgs::msg::CloudInfo>(
...
//        pubLoopConstraintEdge = create_publisher<visualization_msgs::msg::MarkerArray>("/lio_sam/mapping/loop_closure_constraints", 1);
        ...
        pubCloudMapSurface = create_publisher<sensor_msgs::msg::PointCloud2>("lio_sam/mapping/map_surface", 1);
        pubCloudMapCorner = create_publisher<sensor_msgs::msg::PointCloud2>("lio_sam/mapping/map_corner", 1);
    ...
    void allocateMemory()
    {
        ...
        if (pcl::io::loadPCDFile<PointType> (mapCornerPath, *map_corner) == -1) //* load the file
        {
        ...
        if (pcl::io::loadPCDFile<PointType> (mapSurfacePath, *map_surface) == -1) //* load the file
        {
        ...
        pubCloudMapCorner->publish(ros_cloud_corner);
        pubCloudMapSurface->publish(ros_cloud_surface);

        RCLCPP_INFO(this->get_logger(), "\n\n\n\n\n\n\nPUBLISHED\n\n\n\n\n\n\n");
    }

    void laserCloudInfoHandler(const autoware_localization_msgs::msg::CloudInfo::SharedPtr msgIn)
    {
        // extract time stamp
...
//    }
    ...
    void updateInitialGuess()
    {
        ...
        if (cloudKeyPoses3D->points.empty())
        {
            ...
            lastImuTransformation = pcl::getTransformation(-66458, -43619, -42, cloudInfo.imu_roll_init, cloudInfo.imu_pitch_init, cloudInfo.imu_yaw_init); // save imu before return;
            return;
        }
